export const THEME_REGISTRY = {
  ...
  'theme-gadgets': {
    ...
    bgPage: 'bg-[#0b0f19]',
    cardBg: 'bg-[#111827] text-white border border-slate-800',
    headerBg: 'bg-[#0b0f19]/90 backdrop-blur-md border-b border-slate-800 text-white',
    bannerImage: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=1600&auto=format&fit=crop&q=80',
    primaryColor: '#0284c7',
    accentColor: '#38bdf8',
    primaryBtn: 'bg-sky-600 hover:bg-sky-500 text-white shadow-lg shadow-sky-900/30',
    badgeStyle: 'bg-sky-950/80 text-sky-400 border border-sky-800',
    saleBadge: 'bg-gradient-to-r from-sky-500 to-indigo-500 text-white font-semibold',
