      ...
      <main>
        <section className="landing-hero">
          <div className="landing-shell grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-8">
            ...
            <div className="landing-visual" aria-label="Waply app preview"><div className="hero-blob hero-blob-one" /><div className="hero-blob hero-blob-two" /><div className="hero-blob hero-blob-three" /><div className="hero-visual-overlay" /><div className="hero-screenshot-frame">{heroVideo ? <video autoPlay muted loop playsInline poster="/assets/hero-screenshot.png" aria-label="Waply app animation"><source src={heroVideo} type="video/mp4" /></video> : <img src="/assets/hero-screenshot.png" onError={(event) => { event.currentTarget.src = '/WhatsApp%20Image%202026-08-21%20at%209.23.54%20PM.jpeg'; }} alt="Waply app screenshot" />}</div></div>
          </div>
        </section>
